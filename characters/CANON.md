...
The five company portraits and Snicker's were painted for the Fantasy Grounds campaign and are the
**untreated** paintings — the table copies get a contrast pass for token size, these do not. They
are also the `PORTRAITS` map in `index.html`, keyed by the exact Cast name.
...
|---|---|---|---|
| **Theep Gvosh** | [`theep-gvosh.webp`](theep-gvosh.webp) | The Company | Tiefling man, late thirties. **Ash-grey skin with a cold blue undertone**; **short, thick, forward-curving ram's horns** low on the brow, ridged and chipped at the tips; scalp shaved to stubble; a hard narrow face; **eyes with no visible whites, lit from within**; a slender tail. Scorched dark wool and hard-worn leather, high collar, sleeves burned back to the elbow, forearms bare and marked; a satchel of chalk and slate. **His spell light is cold actinic blue-white** and is his signature. *Avoid:* a pointed hat, a hooded robe, a staff, a floating book, red or crimson skin, long swept-back horns, warm firelight on him, more than two horns. |
...
| **Snicker** | [`snicker.webp`](snicker.webp) | The Company | A Tiny old monkey, hand-sized, **ginger-brown fur going grey at the muzzle**, a long prehensile tail. Alert, serious, watching something off frame; never mugging. Lit with Theep's cold blue-white light, on purpose — he should read as belonging to his master. *Avoid:* a cute or comical expression, clothes, a fez, a collar, an organ-grinder, a gorilla or ape, warm firelight. |
...
- **Theep's horns.** Renders lengthen them and sweep them back. They are short, thick and forward-
  curving, and there are two.
